...
- **Specialized machine learning architectures**: [MLPs](https://drenderer.github.io/klax/api/nn/mpl/#klax.nn.MLP) with customizable initialization, [fully](https://drenderer.github.io/klax/api/nn/mlp/#klax.nn.FICNN) and [partially](https://drenderer.github.io/klax/api/nn/mpl/#klax.nn.PICNN) input convex neural networks (ICNNs), matrix-valued neural networks, e.g., [skew symmetric](https://drenderer.github.io/klax/api/nn/matrices/#klax.nn.SkewSymmetricMatrix) matrices, and more.
- **Parameter constraints**: Differentiable and non-differentiable parameter constraints, e.g., [non-negativity](https://drenderer.github.io/klax/api/wrappers/#klax.NonNegative) and [symmetry](https://drenderer.github.io/klax/api/wrappers/#klax.Symmetric) constraints.
- **Highly customizable training and logging utlities**: Methods for [calibrating](https://drenderer.github.io/klax/api/training/#klax.fit) abitrary trainable PyTrees with custom [loss functions](https://drenderer.github.io/klax/api/losses/#klax.Loss), [callbacks](https://drenderer.github.io/klax/api/callbacks/#klax.Callback), and [metrics logging](https://drenderer.github.io/klax/api/logging/#klax.MetricLogger).
